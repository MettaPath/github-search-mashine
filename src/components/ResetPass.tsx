    ...
    return (
        <div className="h-screen flex justify-center items-center">
            <div className="flex flex-col justify-center max-w-[340px] items-center border py-5 px-5 rounded mb-10 shadow-md bg-gray-100">
                <GitHubRed />
                <h3 className="font-mono font-bold text-xl pt-2 mb-4">Reset password</h3>
                <form className="font-mono flex flex-col justify-center mb-2" onSubmit={handleResetPassword}>
                    ...
                    <button className="shadow-md text-sm px-1 mb-1 h-[25px] bg-yellow-400 rounded md:hover:bg-sky-700 hover:text-white transition-all" type="submit">Sent</button>
                </form>
