		...
		<div className="h-screen flex justify-center items-center">
			<div className="flex flex-col justify-center max-w-[340px] items-center border py-5 px-5 rounded mb-10 shadow-md bg-gray-100">
				...
				>
					...
					<button
						className="shadow-md text-sm px-1 mb-1 h-[25px] bg-yellow-400 rounded md:hover:bg-sky-700 md:hover:text-white transition-all"
						type="submit"
					>
						Sign in
					</button>
				...
				<div className="flex flex-col items-center mb-1">
					...
					<button
						...
						className="rounded md:hover:bg-sky-700 transition-all p-0.5"
					>
						<Google />
					</button>
				</div>
